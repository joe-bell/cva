...
:::note
Although `cva` is a [**tiny**](https://bundlephobia.com/package/class-variance-authority) library, it's best to use in an SSR/SSG environment: your user probably doesn't need this JavaScript, especially for static components.
:::
