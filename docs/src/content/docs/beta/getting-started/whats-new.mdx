...
The beta's types still cost more than `0.7`, by design: the beta models composition, schemas and internal variants. See [the pull request](https://github.com/joe-bell/cva/pull/420) for the full numbers.
