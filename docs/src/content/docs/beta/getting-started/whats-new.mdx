...
Import `cva/tailwindcss` to use [`base:` defaults](/beta/getting-started/installation#cvatailwindcss) with Tailwind CSS v4. Ordinary utilities override these defaults through CSS, with no runtime class merging.
