...
Import [`cva/tailwindcss`](/beta/getting-started/installation#cvatailwindcss) in a Tailwind CSS v4 project and prefix component defaults with `base:`. Ordinary utilities override them through the CSS cascade, with no runtime class merging.
