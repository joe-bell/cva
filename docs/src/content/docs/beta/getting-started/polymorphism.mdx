---
title: Polymorphism
description: Apply cva classes to any HTML element, or roll your own render prop with Base UI's useRender.
---
...
export interface ButtonProps
  extends
    useRender.ComponentProps<typeof _BUTTON_DEFAULT_TAG>,
...
export function Button({
  ...
  // Resolve the class string and variant state (e.g. `data-intent="primary"`)
  // from one props object. See /beta/getting-started/tools#pva
  const resolved = pva(button, { intent, className });
...
// Renders:
//   <a href="/contact" class="button bg-blue-500 hover:bg-blue-600 border-transparent text-white" data-intent="primary">
//     Contact
//   </a>
