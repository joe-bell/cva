...
:::caution[Keep composition arrays immutable and typed]
...
`cva` reads the array once, when you create the component, so pushing another component onto it afterwards has no effect. Create the parent again with the full list instead.
:::
