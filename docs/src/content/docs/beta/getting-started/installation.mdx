...
Use the [shadcn CLI](https://ui.shadcn.com/docs/registry/github) to install `cva@beta` and `cn` and create `cva.config.ts` at your project root:

```sh
npx shadcn@latest add joe-bell/cva/cn
```
