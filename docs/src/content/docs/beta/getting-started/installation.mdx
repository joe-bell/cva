...
By default, `cva` joins classes with [`clsx`](https://github.com/lukeed/clsx). It does not resolve conflicting Tailwind CSS utilities.
...
:::caution
The `base:` variant makes defaults overridable through CSS, but it does not guarantee conflict-free styles.
