...
1. `options`
   ...
   - `variants`: your variants schema. Assigning a class value directly to a variant name is [boolean shorthand](/beta/getting-started/variants#boolean-variants) for `{ true: value, false: null }`
