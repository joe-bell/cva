...
The optional strategies below use the same variants, defaults, gallery, and class override row as the basic example. See [Handling class conflicts](/beta/getting-started/installation#handling-class-conflicts) for setup details.
