...
`cva` is a tiny (<BundleSize package="cva" /> compressed) library for building type-safe, variant-driven class names with Tailwind CSS or any other styling approach.
