...
The `cva` package's CommonJS entry, bundled with its `clsx` dependency, is <BundleSize id="beta" /> after esbuild minification and Brotli compression. Your own bundle will differ after tree shaking.
