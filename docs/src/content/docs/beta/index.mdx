...
The `cva` package's CommonJS entry, bundled with its `clsx` dependency, is <BundleSize package="cva" /> after esbuild minification and Brotli compression. Your own bundle will differ after tree shaking.
