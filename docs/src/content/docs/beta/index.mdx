...
`cva` is a tiny (<BundleSize package="cva" /> compressed) library for type-safe, variant-driven class names for any styling approach, with first-class Tailwind CSS support.
