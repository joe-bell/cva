...
The `class-variance-authority` package's CommonJS entry, bundled with its `clsx` dependency, is <BundleSize package="class-variance-authority" /> after esbuild minification and Brotli compression. Your own bundle will differ after tree shaking.
