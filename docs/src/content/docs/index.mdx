...
The `class-variance-authority` package's CommonJS entry, bundled with its `clsx` dependency, is <BundleSize id="stable" /> after esbuild minification and Brotli compression. Your own bundle will differ after tree shaking.
