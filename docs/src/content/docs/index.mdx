...
`cva` is a tiny (<BundleSize package="class-variance-authority" /> compressed) library for type-safe, variant-driven class names for any styling approach, with first-class Tailwind CSS support.
