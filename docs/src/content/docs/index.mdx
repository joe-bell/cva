...
banner:
  content: |
    ...
    <a href="/beta/">See the updated docs →</a>
---

import { Picture } from "astro:assets";

import BundleSize from "../../components/bundle-size.astro";
import WeeklyDownloads from "../../components/weekly-downloads.astro";
...
`cva` is a tiny (<BundleSize package="class-variance-authority" /> compressed) library for building type-safe, variant-driven class names with Tailwind CSS or any other styling approach.
