...
- `pnpm bundlesize` – builds the packages, then measures every Size Limit entry against its budget and writes each package's `bundle-size.json` report
