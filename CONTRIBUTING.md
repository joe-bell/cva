...
- **Tests** should live beside their source as `<source>.test.<ext>`; keep runtime and type assertions together, rather than splitting a source's unit suite by concern.
